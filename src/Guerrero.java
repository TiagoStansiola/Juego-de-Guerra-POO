...
public class Guerrero extends Unidades{

	public Guerrero(String nombre, double vida, double defensa, double ataque) {
	...
	public String toString() {
		return "Guerrero getNombre()=" + getNombre() + ", getVida()=" + getVida() + ", getDefensa()=" + getDefensa()
				+ ", getAtaque()=" + getAtaque() ;
	}
