...
public class Caballeriza extends Unidades{

	public Caballeriza(String nombre, double vida, double defensa, double ataque) {
	...
	public String toString() {
		return "Caballeriza getNombre()=" + getNombre() + ", getVida()=" + getVida() + ", getDefensa()=" + getDefensa()
				+ ", getAtaque()=" + getAtaque() ;
	}
